...
> **历史证据，已被后续状态取代**
>
> 本文仅保留 2026-07-30 至 2026-08-04 微信入口验证的历史事实，不代表当前生产基线。当前能力边界见[当前状态矩阵](./current-status.md)，后续生产证据见[2026-08-14 私聊、群聊及媒体验证记录](./2026-08-14-private-group-media-validation.md)，统一分类与阅读入口见[验证文档索引](../validation/README.md)。
