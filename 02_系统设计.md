...
| **已实现** | Persistent Audit Store、Audit V3 migration、Pending / Finalize / Recovery、RequestID、request-scoped Recorder、degraded 状态、管理员 Audit Query、过滤、分页、签名 Cursor、防篡改、日志脱敏和主要业务 Audit Action。 |
...
- Audit 以 RequestID 和 request-scoped Recorder 关联请求，支持 degraded 状态、管理员查询、过滤、分页、签名 Cursor 与防篡改；Action 覆盖 Token、登录、用户、权限、Share、Browse、Preview、Download、Upload、Modify、Rename、Move、Delete、Archive、WebDAV 和 OnlyOffice。
