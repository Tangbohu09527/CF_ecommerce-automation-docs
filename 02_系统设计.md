...
> 本设计描述准备采用的实现边界。组件职责与权威来源为**已确定**；`CF_agent-gateway` main commit `f0f0ea0cbcc1029104002b566912afabd23423c7` 已落地多项 Gateway 基础模块，正式编排接线、生产数据库与队列选型、部署参数及端到端链路仍为**待实现 / 待确认**。
