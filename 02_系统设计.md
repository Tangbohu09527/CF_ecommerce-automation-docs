...
真实 CFserver reboot 中 Gateway 核心恢复、agent-wechat 保持停止，但 Poll/Delivery 当时被观察为 running/healthy。因此 automatic boot stop gate 未验证；fresh QR 前必须检查并通过 Runtime Controller 显式 stop。
