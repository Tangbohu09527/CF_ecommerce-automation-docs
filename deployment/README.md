...
`docs/deployment/` 下标明 2026-08-11 的文件是 Staging 历史快照，不得直接作为当前生产命令。组件级 Compose、migration、登录脚本和健康接口必须来自目标版本的发布清单及对应组件仓库。当前生产证据见[2026-09-03 Production Closeout](../validation/records/2026-09-03-enterprise-runtime-production-closeout.md)。
